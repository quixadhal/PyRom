...
skill_table["blindness"] = skill_type("blindness", [12, 8, 17, 15], [1, 1, 2, 2], spell_blindness, TAR_CHAR_OFFENSIVE, POS_FIGHTING, gsn_blindness, SLOT( 4), 5, 12, "", "You can see again.", "")
...
skill_table["charm person"] = skill_type("charm person", [20, 53, 25, 53], [1, 1, 2, 2], spell_charm_person, TAR_CHAR_OFFENSIVE, POS_STANDING, gsn_charm_person, SLOT( 7), 5, 12, "", "You feel more self-confident.", "")
...
skill_table["curse"] = skill_type("curse", [18, 18, 26, 22], [1, 1, 2, 2], spell_curse, TAR_OBJ_CHAR_OFF, POS_FIGHTING, gsn_curse, SLOT(17), 20, 12, "curse", "The curse wears off.", "$p is no longer impure.")
...
skill_table["invisibility"] = skill_type("invisibility", [5, 53, 9, 53], [1, 1, 2, 2], spell_invis, TAR_OBJ_CHAR_DEF, POS_STANDING, gsn_invis, SLOT(29), 5, 12, "", "You are no longer invisible.", "$p fades into view.")
...
skill_table["mass invis"] = skill_type("mass invis", [22, 25, 31, 53], [1, 1, 2, 2], spell_mass_invis, TAR_IGNORE, POS_STANDING, gsn_mass_invis, SLOT(69), 20, 24, "", "You are no longer invisible.", "")
...
skill_table["plague"] = skill_type("plague", [23, 17, 36, 26], [1, 1, 2, 2], spell_plague, TAR_CHAR_OFFENSIVE, POS_FIGHTING, gsn_plague, SLOT(503), 20, 12, "sickness", "Your sores vanish.", "")
skill_table["poison"] = skill_type("poison", [17, 12, 15, 21], [1, 1, 2, 2], spell_poison, TAR_OBJ_CHAR_OFF, POS_FIGHTING, gsn_poison, SLOT(33), 10, 12, "poison", "You feel less sick.", "The poison on $p dries up.")
...
skill_table["sanctuary"] = skill_type("sanctuary", [36, 20, 42, 30], [1, 1, 2, 2], spell_sanctuary, TAR_CHAR_DEFENSIVE, POS_STANDING, gsn_sanctuary, SLOT(36), 75, 12, "", "The white aura around your body fades.", "")
...
skill_table["sleep"] = skill_type("sleep", [10, 53, 11, 53], [1, 1, 2, 2], spell_sleep, TAR_CHAR_OFFENSIVE, POS_STANDING, gsn_sleep, SLOT(38), 15, 12, "", "You feel less tired.", "")
...
skill_table["axe"] = skill_type("axe", [1, 1, 1, 1], [6, 6, 5, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_axe, SLOT( 0), 0, 0, "", "!Axe!", "")
skill_table["dagger"] = skill_type("dagger", [1, 1, 1, 1], [2, 3, 2, 2], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_dagger, SLOT( 0), 0, 0, "", "!Dagger!", "")
skill_table["flail"] = skill_type("flail", [1, 1, 1, 1], [6, 3, 6, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_flail, SLOT( 0), 0, 0, "", "!Flail!", "")
skill_table["mace"] = skill_type("mace", [1, 1, 1, 1], [5, 2, 3, 3], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_mace, SLOT( 0), 0, 0, "", "!Mace!", "")
skill_table["polearm"] = skill_type("polearm", [1, 1, 1, 1], [6, 6, 6, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_polearm, SLOT( 0), 0, 0, "", "!Polearm!", "")
skill_table["shield block"] = skill_type("shield block", [1, 1, 1, 1], [6, 4, 6, 2], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_shield_block, SLOT(0), 0, 0, "", "!Shield!", "")
skill_table["spear"] = skill_type("spear", [1, 1, 1, 1], [4, 4, 4, 3], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_spear, SLOT( 0), 0, 0, "", "!Spear!", "")
skill_table["sword"] = skill_type("sword", [1, 1, 1, 1], [5, 6, 3, 2], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_sword, SLOT( 0), 0, 0, "", "!sword!", "")
skill_table["whip"] = skill_type("whip", [1, 1, 1, 1], [6, 5, 5, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_whip, SLOT( 0), 0, 0, "", "!Whip!", "")
skill_table["backstab"] = skill_type("backstab", [53, 53, 1, 53], [0, 0, 5, 0], spell_None, TAR_IGNORE, POS_STANDING, gsn_backstab, SLOT( 0), 0, 24, "backstab", "!Backstab!", "")
skill_table["bash"] = skill_type("bash", [53, 53, 53, 1], [0, 0, 0, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_bash, SLOT( 0), 0, 24, "bash", "!Bash!", "")
skill_table["berserk"] = skill_type("berserk", [53, 53, 53, 18], [0, 0, 0, 5], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_berserk, SLOT( 0), 0, 24, "", "You feel your pulse slow down.", "")
skill_table["dirt kicking"] = skill_type("dirt kicking", [53, 53, 3, 3], [0, 0, 4, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_dirt, SLOT( 0), 0, 24, "kicked dirt", "You rub the dirt out of your eyes.", "")
skill_table["disarm"] = skill_type("disarm", [53, 53, 12, 11], [0, 0, 6, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_disarm, SLOT( 0), 0, 24, "", "!Disarm!", "")
skill_table["dodge"] = skill_type("dodge", [20, 22, 1, 13], [8, 8, 4, 6], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_dodge, SLOT( 0), 0, 0, "", "!Dodge!", "")
skill_table["enhanced damage"] = skill_type("enhanced damage", [45, 30, 25, 1], [10, 9, 5, 3], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_enhanced_damage, SLOT( 0), 0, 0, "", "!Enhanced Damage!", "")
skill_table["envenom"] = skill_type("envenom", [53, 53, 10, 53], [0, 0, 4, 0], spell_None, TAR_IGNORE, POS_RESTING, gsn_envenom, SLOT(0), 0, 36, "", "!Envenom!", "")
skill_table["hand to hand"] = skill_type("hand to hand", [25, 10, 15, 6], [8, 5, 6, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_hand_to_hand, SLOT( 0), 0, 0, "", "!Hand to Hand!", "")
skill_table["kick"] = skill_type("kick", [53, 12, 14, 8], [0, 4, 6, 3], spell_None, TAR_CHAR_OFFENSIVE, POS_FIGHTING, gsn_kick, SLOT( 0), 0, 12, "kick", "!Kick!", "")
skill_table["parry"] = skill_type("parry", [22, 20, 13, 1], [8, 8, 6, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_parry, SLOT( 0), 0, 0, "", "!Parry!", "")
skill_table["rescue"] = skill_type("rescue", [53, 53, 53, 1], [0, 0, 0, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_rescue, SLOT( 0), 0, 12, "", "!Rescue!", "")
skill_table["trip"] = skill_type("trip", [53, 53, 1, 15], [0, 0, 4, 8], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_trip, SLOT( 0), 0, 24, "trip", "!Trip!", "")
skill_table["second attack"] = skill_type("second attack", [30, 24, 12, 5], [10, 8, 5, 3], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_second_attack, SLOT( 0), 0, 0, "", "!Second Attack!", "")
skill_table["third attack"] = skill_type("third attack", [53, 53, 24, 12], [0, 0, 10, 4], spell_None, TAR_IGNORE, POS_FIGHTING, gsn_third_attack, SLOT( 0), 0, 0, "", "!Third Attack!", "") # non-combat skills */
skill_table["fast healing"] = skill_type("fast healing", [15, 9, 16, 6], [8, 5, 6, 4], spell_None, TAR_IGNORE, POS_SLEEPING, gsn_fast_healing, SLOT( 0), 0, 0, "", "!Fast Healing!", "")
skill_table["haggle"] = skill_type("haggle", [7, 18, 1, 14], [5, 8, 3, 6], spell_None, TAR_IGNORE, POS_RESTING, gsn_haggle, SLOT( 0), 0, 0, "", "!Haggle!", "")
skill_table["hide"] = skill_type("hide", [53, 53, 1, 12], [0, 0, 4, 6], spell_None, TAR_IGNORE, POS_RESTING, gsn_hide, SLOT( 0), 0, 12, "", "!Hide!", "")
skill_table["lore"] = skill_type("lore", [10, 10, 6, 20], [6, 6, 4, 8], spell_None, TAR_IGNORE, POS_RESTING, gsn_lore, SLOT( 0), 0, 36, "", "!Lore!", "")
skill_table["meditation"] = skill_type("meditation", [6, 6, 15, 15], [5, 5, 8, 8], spell_None, TAR_IGNORE, POS_SLEEPING, gsn_meditation, SLOT( 0), 0, 0, "", "Meditation", "")
skill_table["peek"] = skill_type("peek", [8, 21, 1, 14], [5, 7, 3, 6], spell_None, TAR_IGNORE, POS_STANDING, gsn_peek, SLOT( 0), 0, 0, "", "!Peek!", "")
skill_table["pick lock"] = skill_type("pick lock", [25, 25, 7, 25], [8, 8, 4, 8], spell_None, TAR_IGNORE, POS_STANDING, gsn_pick_lock, SLOT( 0), 0, 12, "", "!Pick!", "")
skill_table["sneak"] = skill_type("sneak", [53, 53, 4, 10], [0, 0, 4, 6], spell_None, TAR_IGNORE, POS_STANDING, gsn_sneak, SLOT( 0), 0, 12, "", "You no longer feel stealthy.", "")
skill_table["steal"] = skill_type("steal", [53, 53, 5, 53], [0, 0, 4, 0], spell_None, TAR_IGNORE, POS_STANDING, gsn_steal, SLOT( 0), 0, 24, "", "!Steal!", "")
skill_table["scrolls"] = skill_type("scrolls", [1, 1, 1, 1], [2, 3, 5, 8], spell_None, TAR_IGNORE, POS_STANDING, gsn_scrolls, SLOT( 0), 0, 24, "", "!Scrolls!", "")
skill_table["staves"] = skill_type("staves", [1, 1, 1, 1], [2, 3, 5, 8], spell_None, TAR_IGNORE, POS_STANDING, gsn_staves, SLOT( 0), 0, 12, "", "!Staves!", "")
skill_table["wands"] = skill_type("wands", [1, 1, 1, 1], [2, 3, 5, 8], spell_None, TAR_IGNORE, POS_STANDING, gsn_wands, SLOT( 0), 0, 12, "", "!Wands!", "")
skill_table["recall"] = skill_type("recall", [1, 1, 1, 1], [2, 2, 2, 2], spell_None, TAR_IGNORE, POS_STANDING, gsn_recall, SLOT( 0), 0, 12, "", "!Recall!", "")
